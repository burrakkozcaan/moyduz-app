    ...
    <div className="w-full max-w-[440px] rounded-3xl bg-ln-gray-0 p-6 shadow-ln-xs xl:rounded-[28px] mx-auto mt-8 md:mt-12">
      ...
      {status === 'success' ? (
        <div className="rounded-xl border border-green-200 bg-green-50 px-4 py-6 text-center">
          ...
          <p className="mt-1 text-sm text-green-700">1 iş günü içinde yanıt vereceğiz.</p>
        </div>
      ) : (
        <form className="block" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-3">
            <div className="flex w-full flex-col gap-1">
              <label htmlFor="fullname" className="text-ln-label-sm text-ln-gray-800">
                Ad Soyad
              </label>
              <div className="relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" className="pointer-events-none absolute left-[9px] top-1/2 size-[18px] -translate-y-1/2 text-ln-gray-400">
            ...
            <div className="flex w-full flex-col gap-1">
              <label htmlFor="email" className="text-ln-label-sm text-ln-gray-800">
                E-posta
              </label>
              <div className="relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" className="pointer-events-none absolute left-[9px] top-1/2 size-[18px] -translate-y-1/2 text-ln-gray-400">
                  <path fill="currentColor" d="M1.502 5.162A2.25 2.25 0 0 1 3.75 3h10.5a2.25 2.25 0 0 1 2.25 2.162L9.336 8.744a.75.75 0 0 1-.671 0z" />
                  <path fill="currentColor" d="M1.5 6.839v5.911A2.25 2.25 0 0 0 3.75 15h10.5a2.25 2.25 0 0 0 2.25-2.25V6.838l-6.494 3.247a2.25 2.25 0 0 1-2.012 0z" />
                </svg>
                <input
                  className="h-9 w-full rounded-[9px] bg-ln-gray-0 px-2.5 py-2 text-ln-paragraph-sm text-ln-gray-800 shadow-[0_3px_6px_-1.5px_rgba(51,51,51,.06)] ring-1 ring-ln-gray-200 caret-ln-orange transition-all duration-300 ease-out placeholder:transition-all placeholder:duration-300 placeholder:ease-out placeholder:text-ln-gray-500 hover:bg-ln-gray-25 hover:shadow-none hover:ring-transparent hover:placeholder:text-ln-gray-700 focus:bg-ln-gray-0 focus:ring-ln-orange outline-none focus:outline-none pl-[35px]"
                  id="email"
            ...
            <div className="flex w-full flex-col gap-1">
              <label htmlFor="message" className="text-ln-label-sm text-ln-gray-800">
                Mesaj
              </label>
            ...
            <div className="flex w-full flex-col gap-1">
              <label htmlFor="product" className="text-ln-label-sm text-ln-gray-800">
                Ürün / Proje Adı
              </label>
              <div className="relative">
                <input
            ...
            >
              {status === 'loading' ? 'Gönderiliyor...' : 'Mesajımı Gönder'}
            </button>
            <p className="text-center text-xs text-ln-gray-400">
              1 iş günü içinde yanıt vereceğiz.
            </p>
          </div>
        </form>
      )}
