...
export default function PricingPage() {
  ...
  React.useEffect(() => {
    const btn = activeTab === 'personal'
      ? tabBtnPersonalRef.current
      : activeTab === 'business'
        ? tabBtnBusinessRef.current
        : activeTab === 'startup'
          ? tabBtnStartupRef.current
          : tabBtnEnterpriseRef.current;
    ...
    <div className="grid grid-cols-[minmax(160px,1fr)_minmax(0,1fr)] rounded-[28px] bg-ln-gray-0 p-1 shadow-ln-xs md:gap-2 md:rounded-3xl md:p-2 xl:grid-cols-5">
        ...
        >
          ...
          <div className="my-6 flex flex-col items-start">
            <div className="flex items-baseline gap-1.5">
              <span className="text-[36px]/[40px] font-550 text-ln-gray-800">₺7.900</span>
              <span className="text-[13px]/[16px] text-ln-gray-500">/ay</span>
            </div>
            <div className="mt-1 text-[11px]/[14px] text-ln-gray-400">Tek ödemede ₺79.900 · KDV hariç</div>
          </div>
          <a
      ...
      <div className={`flex-col gap-4 px-2.5 py-7 min-[480px]:px-4 sm:gap-5 md:px-7 xl:!flex ${activeTab === 'enterprise' ? 'flex' : 'hidden xl:flex'}`}>
        ...
        >
          ...
          <div className="my-6 flex flex-col items-start">
            <div className="flex items-baseline gap-1.5">
              <span className="text-[36px]/[40px] font-550 text-ln-gray-800">₺23.600</span>
              <span className="text-[13px]/[16px] text-ln-gray-500">/ay</span>
            </div>
            <div className="mt-1 text-[11px]/[14px] text-ln-gray-400">Tek ödemede ₺269.900 · KDV hariç</div>
          </div>
          <a
