...
export const AnimatedDrawer = ({
  ...
  return (
    <>
      <ShadcnButton
        className='focus-visible:shadow-focus-ring-button rounded-full border border-white/10 bg-[#1C1C1C] px-6 py-2 font-medium text-white transition-colors hover:bg-[#262626] md:font-medium'
