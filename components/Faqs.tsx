  ...
  const faqs = [
    {
      ...
      answer:
        'Projenin kapsamına göre değişmekle birlikte çoğu kurumsal web sitesi 2–4 haftada, e-ticaret projeleri 4–8 haftada teslim edilir. İlk görüşmede kapsamı netleştirip size özel bir takvim sunuyoruz.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Her proje ihtiyaca özel fiyatlandırılır. Sabit bütçeli paketlerimizden yararlanabilir ya da kapsama göre özel teklif alabilirsiniz. Ücretsiz keşif görüşmesi için bizimle iletişime geçin.',
    },
    {
