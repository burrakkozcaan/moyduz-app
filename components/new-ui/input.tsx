...
export const inputVariants = tv({
  slots: {
    ...
    wrapper: [
      ...
      'transition duration-200 ease-out',
      // hover
      'hover:bg-bg-weak-50 has-[input:focus]:bg-bg-white-0',
      // disabled
    ...
    hasError: {
      true: {
        root: [
          ...
          // hover (focus state overrides via has-[input:focus] below)
      ...
      false: {
        root: [
          // hover (focus state overrides via default has-[input:focus] styles)
