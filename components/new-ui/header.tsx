      ...
      <div className="relative z-50 w-full flex-col items-center xl:container lg:flex xl:mx-auto lg:mt-6">
        <div className="relative z-20 flex w-full items-center justify-center gap-8 mac:justify-stretch">
          <div className="relative hidden h-px flex-1 bg-ln-gray-200 bleed-bg-l bleed-ln-gray-200 mac:block">
            <img src="/images/landing/dot.png" width={9} height={9} alt="" className="absolute z-30 min-h-[9px] min-w-[9px] -top-1 -left-[37px]" />
            <img src="/images/landing/dot.png" width={9} height={9} alt="" className="absolute z-30 min-h-[9px] min-w-[9px] -right-px -top-1" />
          </div>
          ...
          <div className="relative hidden h-px flex-1 bg-ln-gray-200 bleed-bg-r bleed-ln-gray-200 mac:block">
            <img src="/images/landing/dot.png" width={9} height={9} alt="" className="absolute z-30 min-h-[9px] min-w-[9px] -top-1 -right-[37px] left-auto" />
            <img src="/images/landing/dot.png" width={9} height={9} alt="" className="absolute z-30 min-h-[9px] min-w-[9px] -top-1 -left-px" />
          </div>
        </div>
